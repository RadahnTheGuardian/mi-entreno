...
const ROUTINE = {
  push: {
    ...
    ejercicios: [
      ...
      { id: "press_inclinado",  nombre: "Press inclinado con mancuernas",   series: 3, repMin: 8,  repMax: 10, rir: "RIR 1" },
      { id: "press_militar",    nombre: "Press militar con barra",          series: 3, repMin: 8,  repMax: 10, rir: "RIR 1" },
      { id: "fondos",           nombre: "Fondos en paralelas (lastre opc.)", series: 3, repMin: 10, repMax: 12, rir: "RIR 1" },
  ...
  pull: {
    ...
    dias: [2, 5],
    ejercicios: [
      { id: "dominadas",     nombre: "Dominadas (lastre opcional)", series: 4, repMin: 6,  repMax: 10, rir: "RIR 1" },
  ...
  legs: {
    ...
    ejercicios: [
      ...
      { id: "peso_muerto_rum", nombre: "Peso muerto rumano",       series: 3, repMin: 8,  repMax: 10, rir: "RIR 1" },
